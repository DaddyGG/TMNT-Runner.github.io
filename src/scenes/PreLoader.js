...
import highscoreBtn from '../assets/buttons/highscore.png';
...
import highscorePressed from '../assets/buttons/pressed/highscore.png';
import playerJump from '../assets/player/jump.png';
import playerFalling from '../assets/player/fall.png';
...
import instructionBg from '../assets/hero-dark.png';
...
export default class PreLoad extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('highscore', highscoreBtn);
    ...
    this.load.image('highscorePressed', highscorePressed);
